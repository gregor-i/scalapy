...
```
## Execution
ScalaPy officially supports Python 3.{7, 8, 9, 10, 11, 12, 13}. If you want to use another version of Python, you should either define the environment variable `SCALAPY_PYTHON_LIBRARY`
